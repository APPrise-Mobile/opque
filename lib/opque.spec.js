...
describe('Operations Queue', function () {
  ...
  it('should call the cb once because the opLimit was reached', function() {
    let flushCb = sandbox.stub();
    let opQ = new OpQue({
      flushTime: 1000000,
      flushCb: flushCb,
  ...
  it('should not call the cb because there is no opLimit and the flushTimer hasnt been reached', function () {
    let flushCb = sandbox.stub();
    let opQ = new OpQue({
      flushTime: 1000000,
      flushCb: flushCb,
